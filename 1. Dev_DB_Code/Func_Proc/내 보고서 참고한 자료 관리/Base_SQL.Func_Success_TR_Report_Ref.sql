CREATE OR REPLACE FUNCTION "Base_SQL"."Func_Success_TR_Report_Ref"(
...
/*    
-- ************************************************************************************ --
Create Name	: 내 보고서 참고한 자료 Success
...
*/
    ...
    RETURN QUERY SELECT
        1111 AS "ErrorCheck",
        'success' AS "Status",
        '내 보고서 참고한 자료가 승인되었습니다.' AS "Message",
        "InData_ReportSeq" AS "ReportSeq",
        "InData_RefSeq" AS "RefSeq";
END;
$$;

SELECT * FROM "Base_SQL"."Func_Success_TR_Report_Ref"('test_UserSeq0912843024', 2, 1);